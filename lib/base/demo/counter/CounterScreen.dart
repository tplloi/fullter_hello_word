...
class CounterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CounterHomePage(title: 'Loitp Flutter Demo Home Page'),
    );
  }
}
...
class CounterHomePage extends StatefulWidget {
  ...
  // case the title) provided by the parent (in this case the App base.widget) and
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          // Column is also a layout base.widget. It takes a list of children and
          ...
          // to see the wireframe for each base.widget.
          //
          ...
          children: <Widget>[
            Text(
              'Loitp You have pushed the button this many times:',
            ),
            Text(
              '$_counter',
